...
import { SECURITY_PEOPLE } from '../../data/security.js'

function matchesBase(emp, location, search) {
  const q = search.trim().toLowerCase()
  const locOk = location === 'all' || emp.yards.some((y) => y.toLowerCase() === location.toLowerCase())
  const searchOk =
    !q ||
...
function GuardRow({ emp, onOpenPerson, onApprove, onResolvePunch }) {
